...
S'appuie sur data_loader.py pour l'extraction et le nettoyage
...
from mistralchat.ingestion.data_loader import load_and_parse_files
...
if __name__ == "__main__":
    import sys
    from mistralchat.config import (
